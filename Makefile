...
CORE_OBJS = ds4.o ds4_distributed.o ds4_ssd.o ds4_metal.o ds4_cpu_stream.o
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_ssd.o ds4_cpu_stream.o
else
...
CORE_OBJS = ds4.o ds4_distributed.o ds4_ssd.o ds4_cuda.o ds4_cpu_stream.o
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_ssd.o ds4_cpu_stream.o
...
strix-halo:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-eval ds4-agent \
		CORE_OBJS="ds4.o ds4_distributed.o ds4_ssd.o ds4_rocm.o ds4_cpu_stream.o" \
...
ds4_cpu_stream.o: ds4_cpu_stream.c ds4_cpu_stream.h
	$(CC) $(CFLAGS) -c -o $@ ds4_cpu_stream.c
